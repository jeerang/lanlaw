...
if (isset($_GET['delete'])) {
    ...
    redirect(BASE_URL . 'admin/disbursement_types/');
}
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span><i class="fas fa-receipt me-2"></i>รายการประเภทการเบิก</span>
        <a href="add.php" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i>เพิ่มประเภทการเบิก</a>
    </div>
    <div class="card-body">
