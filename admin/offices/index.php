...
$pageTitle = 'จัดการสำนักงานเจ้าของงาน';
$tableName = 'offices';
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span><i class="fas fa-building me-2"></i>รายการสำนักงานเจ้าของงาน</span>
        <a href="add.php" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i>เพิ่มสำนักงาน</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover datatable">
                <thead><tr><th width="5%">#</th><th>รหัส</th><th>ชื่อสำนักงาน</th><th>ชื่อย่อ</th><th>ผู้ติดต่อ</th><th>โทรศัพท์</th><th>สถานะ</th><th width="15%">จัดการ</th></tr></thead>
                <tbody>
