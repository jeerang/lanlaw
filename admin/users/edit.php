...
if (!$user) {
    setFlashMessage('danger', 'ไม่พบข้อมูลผู้ใช้งาน');
...
<div class="card">
    <div class="card-header">
        <i class="fas fa-user-edit me-2"></i><?php echo $pageTitle; ?>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">ไม่สามารถเปลี่ยนสิทธิ์ตัวเองได้</small>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">ไม่สามารถเปลี่ยนสถานะตัวเองได้</small>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
