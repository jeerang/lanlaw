...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt = $db->prepare("INSERT INTO cases (" . implode(',', $fields) . ") VALUES (" . implode(',', $placeholders) . ")");
            $stmt->execute(array_values($data));
            logActivity('create', 'cases', $db->lastInsertId(), null, $data);
            setFlashMessage('success', 'เพิ่มคดีสำเร็จ');
        ...
        <form method="POST">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control <?php echo isset($errors['debtor_code']) ? 'is-invalid' : ''; ?>" name="debtor_code" value="<?php echo e($_POST['debtor_code'] ?? ''); ?>" required>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-select" name="status">
                        <option value="active" <?php echo ($_POST['status'] ?? 'active') == 'active' ? 'selected' : ''; ?>>กำลังดำเนินการ</option>
